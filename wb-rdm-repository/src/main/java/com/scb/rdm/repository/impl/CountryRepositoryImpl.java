...
public class CountryRepositoryImpl extends
		GenericCrudRepositoryImpl<CountryCode, CountryKey> implements
		CountryRepository {
	...
	public void init() {
		...
		System.out.println("Executing findByInternalCountryRegionCodeAndStatus: ");
		List<CountryCode> countryCodeList = this.findByInternalCountryRegionCodeAndStatus("EUR", null);
		System.out.println("No. of records retrieved" + countryCodeList.size());
		for(CountryCode cc : countryCodeList)
		{
			System.out.println("CC with InternalCountryRegion as EUR" + cc.getCountryCodeDescription());
		}
	}

	@Override
	public CountryCode findByCountryCode(String countryCode) {
		CountryCode countryCodeResult = (CountryCode) entityManager
	...
	public List<CountryCode> findByInternalCountryRegionCodeAndStatus(
		...
		List<CountryCode> countryCodeList = entityManager
				.createNamedQuery(
						"findByInternalCountryRegionCodeAndStatus")
